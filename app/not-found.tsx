...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-background text-primary font-sans flex flex-col selection:bg-accent selection:text-white">
      <SiteNav />
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="relative select-none mb-8">
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="border-4 border-accent/30 rounded-2xl px-6 py-2 rotate-[-8deg] opacity-60">
        ...
        {/* Message */}
        <h1 className="text-2xl md:text-3xl font-bold text-primary tracking-tight mb-3 font-heading text-balance">
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full max-w-xs sm:max-w-none sm:justify-center">
          <Link
            href="/"
            className="h-11 px-6 bg-primary hover:opacity-90 text-background text-xs font-bold rounded-full flex items-center justify-center gap-2 transition-all shadow-xs cursor-pointer"
          >
          ...
          <Link
            href="/create"
            className="h-11 px-6 border border-border-default bg-surface hover:bg-surface-2 text-primary text-xs font-bold rounded-full flex items-center justify-center gap-2 transition-all cursor-pointer"
          >
          ...
          <div className="grid grid-cols-2 gap-2">
            {[
              ...
              <Link
                key={item.href}
                href={item.href}
                className="flex items-center gap-2 p-3 rounded-2xl border border-border-default bg-surface hover:border-accent/30 hover:bg-surface-2 transition-all text-left text-xs font-semibold text-muted-text hover:text-accent"
              >
      ...
      <footer className="py-6 px-6 border-t border-border-default text-[10px] text-muted-text bg-surface flex items-center justify-between">
        <span className="font-bold text-primary font-heading">CardQR</span>
